  ...
  MTS.registerLocale('es', {
    'MTS.Accordion': {
      demo: {
        ...
        s5Title:             '5 — Items dinámicos — addItem / removeItem / updateItem',

        resultBasic:         '— abre o cierra un panel —',
        resultApi:           '— usa los botones —',
        resultDyn:           '— agrega, renombra o quita items en tiempo de ejecución —',
        dynField:            'Campo',
        dynBody:             'Contenido vivo — agregado en tiempo de ejecución, sin reconstruir el resto.',
        dynItems:            'items',
        dynEmpty:            'sin items',
        dynRenamed:          'Campo renombrado',
        onOpenPrefix:        'onOpen → ',
  ...
  MTS.registerLocale('en', {
    'MTS.Accordion': {
      demo: {
        ...
        s5Title:             '5 — Dynamic items — addItem / removeItem / updateItem',

        resultBasic:         '— open or close a panel —',
        resultApi:           '— use the buttons —',
        resultDyn:           '— add, rename or remove items at runtime —',
        dynField:            'Field',
        dynBody:             'Live content — added at runtime, never rebuilt.',
        dynItems:            'items',
        dynEmpty:            'no items',
        dynRenamed:          'Renamed field',
        onOpenPrefix:        'onOpen → ',
        onClosePrefix:       'onClose → ',
  ...
  MTS.registerLocale('pt', {
    'MTS.Accordion': {
      demo: {
        ...
        s5Title:             '5 — Itens dinâmicos — addItem / removeItem / updateItem',

        resultBasic:         '— abra ou feche um painel —',
        resultApi:           '— use os botões —',
        resultDyn:           '— adicione, renomeie ou remova itens em tempo de execução —',
        dynField:            'Campo',
        dynBody:             'Conteúdo vivo — adicionado em tempo de execução, sem reconstruir o resto.',
        dynItems:            'itens',
        dynEmpty:            'sem itens',
        dynRenamed:          'Campo renomeado',
        onOpenPrefix:        'onOpen → ',
        onClosePrefix:       'onClose → ',
